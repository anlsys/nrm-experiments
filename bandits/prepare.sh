...
echo "999424"       > /sys/devices/virtual/powercap/intel-rapl/intel-rapl:0/constraint_0_time_window_us
echo "125000000"    > /sys/devices/virtual/powercap/intel-rapl/intel-rapl:0/constraint_0_power_limit_uw

echo "999424"       > /sys/devices/virtual/powercap/intel-rapl/intel-rapl:1/constraint_0_time_window_us
echo "125000000"    > /sys/devices/virtual/powercap/intel-rapl/intel-rapl:1/constraint_0_power_limit_uw
